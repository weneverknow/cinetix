...
class PageBloc extends Bloc<PageEvent, PageState> {
  ...
  Stream<PageState> mapEventToState(
    ...
    if (event is GoToSplashPage) {
      ...
      yield OnSuccessPage(event.ticket, event.flutixTransaction,
          pageEvent: event.pageEvent);
    } else if (event is GoToTicketDetailPage) {
      yield OnTicketDetailPage(event.ticket, pageEvent: event.pageEvent);
      ...
      yield OnComingSoonDetailPage(event.movie,
          movieDetail: event.movieDetail, credits: event.credits);
    } else if (event is GoToTicketToday) {
      yield OnTicketToday();
    }
  }
}
